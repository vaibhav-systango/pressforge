            ...
            {showWorkspaceMenu && !isClient && (
              <div className="absolute top-full left-0 right-0 mt-1.5 bg-bg-card border border-border-primary rounded-xl shadow-lg z-20 py-1.5 transition-colors duration-200">
                {state.workspaces.map((ws) => (
                  ...
                  >
                    <div className="w-6 h-6 rounded-full bg-slate-200 dark:bg-slate-800 flex items-center justify-center text-text-secondary text-xs font-bold">
                      {ws.name.charAt(0)}
                    </div>
                ...
                <div className="flex items-center gap-3">
                  <div className="relative">
                    ...
                    >
                      ...
                      <span>{state.organizationName}</span>
